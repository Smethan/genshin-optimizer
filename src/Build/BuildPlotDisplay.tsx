...
import { Alert, Box, Button, ButtonGroup, CardContent, Divider, Grid, Link, Typography } from '@mui/material';
...
import { ArtifactsBySlot, BuildRequest, BuildSetting } from '../Types/Build';
...
import { buildContext, calculateTotalBuildNumber } from './Build';
...
export default function BuildDisplay({ location: { characterKey: propCharacterKey } }) {
  ...
  const { setFilters, statFilters, mainStatKeys, optimizationTarget, mainStatAssumptionLevel, useExcludedArts, useEquippedArts } = buildSettings
